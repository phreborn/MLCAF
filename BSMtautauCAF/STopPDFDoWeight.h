...
#ifndef __STopPDFDoWeight__
#define __STopPDFDoWeight__

#include "BSMtautauCAF/LepHadObservable.h"

class STopPDFDoWeight : public LepHadObservable {

public:
  ClassDef(STopPDFDoWeight, 1);

  STopPDFDoWeight();
  STopPDFDoWeight(const TString& expression);
  virtual ~STopPDFDoWeight() = default;
