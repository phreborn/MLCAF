...
#ifndef __STopPDFUpWeight__
#define __STopPDFUpWeight__

#include "BSMtautauCAF/LepHadObservable.h"

class STopPDFUpWeight : public LepHadObservable {

public:
  ClassDef(STopPDFUpWeight, 1);

  STopPDFUpWeight();
  STopPDFUpWeight(const TString& expression);
  virtual ~STopPDFUpWeight() = default;
