...
#ifndef __TTBarPDFUpWeight__
#define __TTBarPDFUpWeight__

#include "BSMtautauCAF/LepHadObservable.h"

class TTBarPDFUpWeight : public LepHadObservable {

public:
  ClassDef(TTBarPDFUpWeight, 1);

  TTBarPDFUpWeight();
  TTBarPDFUpWeight(const TString& expression);
  virtual ~TTBarPDFUpWeight() = default;
