...
*/
  ...
  ///////////////////////////////
  //
  //  2D ff pt * dphi parametrization for ehad only
  //
  ///////////////////////////////

  tempFile=TFile::Open("FakeFactors/FLR15BvetoehadLeptonPtDphi1ELEBVETOFF.root");
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBvetoehadLeptonPtDphi1ELEBVETOFF.root " << std::endl;
  else
  {
  ...
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBvetoehadLeptonPtDphi2ELEBVETOFF.root " << std::endl;
  else
  {
  ...
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBvetoehadLeptonPtDphi3ELEBVETOFF.root " << std::endl;
  else
  {
  ...
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBvetoehadLeptonPtDphi4ELEBVETOFF.root " << std::endl;
  else
  {
  ...
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBtagehadLeptonPtDphi1ELEBTAGFF.root " << std::endl;
  else
  {
  ...
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBtagehadLeptonPtDphi2ELEBTAGFF.root " << std::endl;
  else
  {
  ...
  if(!tempFile) std::cout << "ERROR cant open FF file FLRBtagehadLeptonPtDphi3ELEBTAGFF.root " << std::endl;
  else
  {
