...
*/
  ...
  double ff_ew(1),errff_ew(0);
  if( f_tau_0_n_charged_tracks==1 )
  {
    ff_ew    = f_n_bjets==0?  h_ff_wcr_1p_0tag->GetBinContent( h_ff_wcr_1p_0tag->FindBin(f_tau_0_pt) ):
                              h_ff_wcr_1p_1tag->GetBinContent( h_ff_wcr_1p_1tag->FindBin(f_tau_0_pt) );
    errff_ew = f_n_bjets==0?  fabs(h_ff_wcr_1p_0tag_up->GetBinContent( h_ff_wcr_1p_0tag_up->FindBin(f_tau_0_pt) ) -
                                   h_ff_wcr_1p_0tag_down->GetBinContent( h_ff_wcr_1p_0tag_down->FindBin(f_tau_0_pt) ) ) :
                              fabs(h_ff_wcr_1p_1tag_up->GetBinContent( h_ff_wcr_1p_1tag_up->FindBin(f_tau_0_pt) ) -
                                   h_ff_wcr_1p_1tag_down->GetBinContent( h_ff_wcr_1p_1tag_down->FindBin(f_tau_0_pt) ) );
    errff_ew /= 2.;
  }
  else if( f_tau_0_n_charged_tracks==3 )
  {
    ff_ew    = f_n_bjets==0?  h_ff_wcr_3p_0tag->GetBinContent( h_ff_wcr_3p_0tag->FindBin(f_tau_0_pt) ):
                              h_ff_wcr_3p_1tag->GetBinContent( h_ff_wcr_3p_1tag->FindBin(f_tau_0_pt) );
    errff_ew = f_n_bjets==0?  fabs(h_ff_wcr_3p_0tag_up->GetBinContent(   h_ff_wcr_3p_0tag_up->FindBin(f_tau_0_pt) ) -
                                   h_ff_wcr_3p_0tag_down->GetBinContent( h_ff_wcr_3p_0tag_down->FindBin(f_tau_0_pt) ) ) :
                              fabs(h_ff_wcr_3p_1tag_up->GetBinContent(   h_ff_wcr_3p_1tag_up->FindBin(f_tau_0_pt) ) -
                                   h_ff_wcr_3p_1tag_down->GetBinContent( h_ff_wcr_3p_1tag_down->FindBin(f_tau_0_pt) ) );
    errff_ew /= 2.;
  }
  ...
  double ff_ptdphi_ew(1),errff_ptdphi_ew(0);
  if( f_tau_0_n_charged_tracks==1 )
  {
    if (f_lephad_met_lep1_cos_dphi<1.)
    {
      ff_ptdphi_ew  =         h_ff_wcr_1p_dphi1_0tag->GetBinContent(      h_ff_wcr_1p_dphi1_0tag->FindBin(f_tau_0_pt) );
      errff_ptdphi_ew = fabs( h_ff_wcr_1p_dphi1_0tag_up->GetBinContent(   h_ff_wcr_1p_dphi1_0tag_up->FindBin(f_tau_0_pt) ) -
                              h_ff_wcr_1p_dphi1_0tag_down->GetBinContent( h_ff_wcr_1p_dphi1_0tag_down->FindBin(f_tau_0_pt) ) );
    }
    else if (f_lephad_met_lep1_cos_dphi>=1.&&f_lephad_met_lep1_cos_dphi<2.)
    {
      ff_ptdphi_ew  =         h_ff_wcr_1p_dphi2_0tag->GetBinContent(      h_ff_wcr_1p_dphi2_0tag->FindBin(f_tau_0_pt) );
      errff_ptdphi_ew = fabs( h_ff_wcr_1p_dphi2_0tag_up->GetBinContent(   h_ff_wcr_1p_dphi2_0tag_up->FindBin(f_tau_0_pt) ) -
                              h_ff_wcr_1p_dphi2_0tag_down->GetBinContent( h_ff_wcr_1p_dphi2_0tag_down->FindBin(f_tau_0_pt) ) );
    }
    else if (f_lephad_met_lep1_cos_dphi>=2.)
    {
      ff_ptdphi_ew  =         h_ff_wcr_1p_dphi3_0tag->GetBinContent(      h_ff_wcr_1p_dphi3_0tag->FindBin(f_tau_0_pt) );
      errff_ptdphi_ew = fabs( h_ff_wcr_1p_dphi3_0tag_up->GetBinContent(   h_ff_wcr_1p_dphi3_0tag_up->FindBin(f_tau_0_pt) ) -
                              h_ff_wcr_1p_dphi3_0tag_down->GetBinContent( h_ff_wcr_1p_dphi3_0tag_down->FindBin(f_tau_0_pt) ) );
    }
    errff_ptdphi_ew /= 2.;
  }
  else if( f_tau_0_n_charged_tracks==3 )
  {
    if (f_lephad_met_lep1_cos_dphi<1.)
    {
      ff_ptdphi_ew  =         h_ff_wcr_3p_dphi1_0tag->GetBinContent(      h_ff_wcr_3p_dphi1_0tag->FindBin(f_tau_0_pt) );
      errff_ptdphi_ew = fabs( h_ff_wcr_3p_dphi1_0tag_up->GetBinContent(   h_ff_wcr_3p_dphi1_0tag_up->FindBin(f_tau_0_pt) ) -
                              h_ff_wcr_3p_dphi1_0tag_down->GetBinContent( h_ff_wcr_3p_dphi1_0tag_down->FindBin(f_tau_0_pt) ) );
    }
    else if (f_lephad_met_lep1_cos_dphi>=1.&&f_lephad_met_lep1_cos_dphi<2.)
    {
      ff_ptdphi_ew  =         h_ff_wcr_3p_dphi2_0tag->GetBinContent(      h_ff_wcr_3p_dphi2_0tag->FindBin(f_tau_0_pt) );
      errff_ptdphi_ew = fabs( h_ff_wcr_3p_dphi2_0tag_up->GetBinContent(   h_ff_wcr_3p_dphi2_0tag_up->FindBin(f_tau_0_pt) ) -
                              h_ff_wcr_3p_dphi2_0tag_down->GetBinContent( h_ff_wcr_3p_dphi2_0tag_down->FindBin(f_tau_0_pt) ) );
    }
    else if (f_lephad_met_lep1_cos_dphi>=2.)
    {
      ff_ptdphi_ew  =         h_ff_wcr_3p_dphi3_0tag->GetBinContent(      h_ff_wcr_3p_dphi3_0tag->FindBin(f_tau_0_pt) );
      errff_ptdphi_ew = fabs( h_ff_wcr_3p_dphi3_0tag_up->GetBinContent(   h_ff_wcr_3p_dphi3_0tag_up->FindBin(f_tau_0_pt) ) -
                              h_ff_wcr_3p_dphi3_0tag_down->GetBinContent( h_ff_wcr_3p_dphi3_0tag_down->FindBin(f_tau_0_pt) ) );
    }
    errff_ptdphi_ew /= 2.;
  }
...
*/
  ...
  if      (fflabel=="FFW")      retval = ff_ew;
  //else if (fflabel=="FFWDPHI")  retval = ff_ew * nonclosure_W;
  else if (fflabel=="FFWPTDPHI")retval = f_n_bjets==0? ff_ptdphi_ew : ff_ew;
...
ptReweight::ptReweight(const TString& expression) : LepHadObservable(expression)
{
  ...
  {
    h_ff_wcr_1p_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1p");            h_ff_wcr_1p_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_1p_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1p_up");        h_ff_wcr_1p_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_1p_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1p_down");    h_ff_wcr_1p_0tag_down->SetDirectory(m_histoDir);
  ...
  {
    h_ff_wcr_3p_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3p");            h_ff_wcr_3p_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_3p_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3p_up");        h_ff_wcr_3p_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_3p_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3p_down");    h_ff_wcr_3p_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_1p_1tag = (TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag1p");            h_ff_wcr_1p_1tag->SetDirectory(m_histoDir);
    h_ff_wcr_1p_1tag_up=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag1p_up");        h_ff_wcr_1p_1tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_1p_1tag_down=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag1p_down");    h_ff_wcr_1p_1tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_3p_1tag = (TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag3p");            h_ff_wcr_3p_1tag->SetDirectory(m_histoDir);
    h_ff_wcr_3p_1tag_up=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag3p_up");        h_ff_wcr_3p_1tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_3p_1tag_down=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag3p_down");    h_ff_wcr_3p_1tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_1p_1tag = (TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag1p");            h_ff_wcr17_1p_1tag->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_1tag_up=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag1p_up");        h_ff_wcr17_1p_1tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_1tag_down=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag1p_down");    h_ff_wcr17_1p_1tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_3p_1tag = (TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag3p");            h_ff_wcr17_3p_1tag->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_1tag_up=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag3p_up");        h_ff_wcr17_3p_1tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_1tag_down=(TH1F*)tempFile->Get("BtagFF_lephad_TauPtFFBtag3p_down");    h_ff_wcr17_3p_1tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  //////////////////////////////////////
  //////////////////////////////////////
  ...
  {
    h_ff_wcr_1p_dphi1_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi1");            h_ff_wcr_1p_dphi1_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_1p_dphi1_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi1_up");        h_ff_wcr_1p_dphi1_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_1p_dphi1_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi1_down");    h_ff_wcr_1p_dphi1_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_1p_dphi2_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi2");            h_ff_wcr_1p_dphi2_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_1p_dphi2_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi2_up");        h_ff_wcr_1p_dphi2_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_1p_dphi2_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi2_down");    h_ff_wcr_1p_dphi2_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_1p_dphi3_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi3");            h_ff_wcr_1p_dphi3_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_1p_dphi3_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi3_up");        h_ff_wcr_1p_dphi3_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_1p_dphi3_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi3_down");    h_ff_wcr_1p_dphi3_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_3p_dphi1_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi1");            h_ff_wcr_3p_dphi1_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_3p_dphi1_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi1_up");        h_ff_wcr_3p_dphi1_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_3p_dphi1_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi1_down");    h_ff_wcr_3p_dphi1_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_3p_dphi2_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi2");            h_ff_wcr_3p_dphi2_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_3p_dphi2_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi2_up");        h_ff_wcr_3p_dphi2_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_3p_dphi2_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi2_down");    h_ff_wcr_3p_dphi2_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr_3p_dphi3_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi3");            h_ff_wcr_3p_dphi3_0tag->SetDirectory(m_histoDir);
    h_ff_wcr_3p_dphi3_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi3_up");        h_ff_wcr_3p_dphi3_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr_3p_dphi3_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi3_down");    h_ff_wcr_3p_dphi3_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_1p_dphi1_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi1");            h_ff_wcr17_1p_dphi1_0tag->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_dphi1_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi1_up");        h_ff_wcr17_1p_dphi1_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_dphi1_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi1_down");    h_ff_wcr17_1p_dphi1_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_1p_dphi2_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi2");            h_ff_wcr17_1p_dphi2_0tag->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_dphi2_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi2_up");        h_ff_wcr17_1p_dphi2_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_dphi2_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi2_down");    h_ff_wcr17_1p_dphi2_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_1p_dphi3_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi3");            h_ff_wcr17_1p_dphi3_0tag->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_dphi3_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi3_up");        h_ff_wcr17_1p_dphi3_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_1p_dphi3_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto1pDphi3_down");    h_ff_wcr17_1p_dphi3_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_3p_dphi1_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi1");            h_ff_wcr17_3p_dphi1_0tag->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_dphi1_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi1_up");        h_ff_wcr17_3p_dphi1_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_dphi1_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi1_down");    h_ff_wcr17_3p_dphi1_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_3p_dphi2_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi2");            h_ff_wcr17_3p_dphi2_0tag->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_dphi2_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi2_up");        h_ff_wcr17_3p_dphi2_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_dphi2_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi2_down");    h_ff_wcr17_3p_dphi2_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  {
    h_ff_wcr17_3p_dphi3_0tag = (TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi3");            h_ff_wcr17_3p_dphi3_0tag->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_dphi3_0tag_up=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi3_up");        h_ff_wcr17_3p_dphi3_0tag_up->SetDirectory(m_histoDir);
    h_ff_wcr17_3p_dphi3_0tag_down=(TH1F*)tempFile->Get("BvetoFF_lephad_TauPtFFBveto3pDphi3_down");    h_ff_wcr17_3p_dphi3_0tag_down->SetDirectory(m_histoDir);
    tempFile->Close(); delete tempFile; tempFile=0;
  }
  ...
  //TFile *infile_rqcd_fixed = new TFile( "/afs/cern.ch/user/k/kluonas/public/HtautauStuff/rQCD_Mar10_tag-26-05.root" );
...
/*
  ...
  TFile *infile_dphiW25 = new TFile("/afs/cern.ch/user/k/kluonas/public/HtautauStuff/MyDphiCorrection25PT.root");
  TFile *infile_dphiW30 = new TFile("/afs/cern.ch/user/k/kluonas/public/HtautauStuff/MyDphiCorrection30PT.root");
  TFile *infile_dphiW40 = new TFile("/afs/cern.ch/user/k/kluonas/public/HtautauStuff/MyDphiCorrection40PT.root");
  TFile *infile_dphiW60 = new TFile("/afs/cern.ch/user/k/kluonas/public/HtautauStuff/MyDphiCorrection60PT.root");
