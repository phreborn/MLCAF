#include "Htautau2015/MVis_ll_v05.h"
#include <limits>
...
ClassImp(MVis_ll_v05)

//______________________________________________________________________________________________

MVis_ll_v05::MVis_ll_v05(){
  // default constructor
...
TObjArray* MVis_ll_v05::getBranchNames() const {
  ...
  bnames->Add(new TObjString("dilep_vis_mass"));
...
double MVis_ll_v05::getValue() const {
  ...
  */
  ...
  if(idx0 >=0 && idx1>=0){
    //std::cout << "In OBS: " << leptons_pt->EvalInstance(idx0) << " " << leptons_pt->EvalInstance(idx1) << std::endl;
    ...
    retval = dilep_vis_mass->EvalInstance(dilepI);
  }

  //if(idx0 >=0 && idx1>=0){
  //  lep0.SetPtEtaPhiM(leptons_pt->EvalInstance(idx0), leptons_eta->EvalInstance(idx0), leptons_phi->EvalInstance(idx0), leptons_m->EvalInstance(idx0));
  ...
  //}
  //else {
  //  std::cout<< "WARNING in MVis:: Have negative lep indices!!" << std::endl;
  //}
  //retval = (lep0+lep1).M();
...
MVis_ll_v05::MVis_ll_v05(const TString& expression):
...
const TString& MVis_ll_v05::getExpression() const {
...
bool MVis_ll_v05::hasExpression() const {
...
void MVis_ll_v05::setExpression(const TString& expr){
  // set the expression to a given string
  this->fExpression = expr;
}
//______________________________________________________________________________________________

bool MVis_ll_v05::parseExpression(const TString& expr){
...
void MVis_ll_v05::clearParsedExpression(){
  // clear the current expression
}

//______________________________________________________________________________________________

TString MVis_ll_v05::getActiveExpression() const {
...
bool MVis_ll_v05::initializeSelf(){
  ...
  this->dilep_vis_mass = new TTreeFormula( "dilep_vis_mass", "dilep_vis_mass", this->fTree);
