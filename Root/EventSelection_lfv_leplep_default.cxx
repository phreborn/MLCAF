...
ClassImp(EventSelection_lfv_leplep_default)

//______________________________________________________________________________________________
EventSelection_lfv_leplep_default::EventSelection_lfv_leplep_default(const TString& expression, int systematic, int flag):EventSelection_leplep_base(expression,systematic,flag){
}
//______________________________________________________________________________________________
EventSelection_lfv_leplep_default::~EventSelection_lfv_leplep_default() {
  // default destructor
}

//bool EventSelection_lfv_leplep_default::add_lepton_sf_brachnes() {
//  EventSelection_leplep_base < EventSelection_lfv_leplep_default >::add_lepton_sf_brachnes();
...
//
//
//bool EventSelection_lfv_leplep_default::add_trigger_sf_brachnes() {
//  EventSelection_leplep_base < EventSelection_lfv_leplep_default >::add_trigger_sf_brachnes();
...
//
//
//bool EventSelection_lfv_leplep_default::el_selection(int el_idx) const {
...
//      std::cout << "e fail " << el_idx << " " <<  m_leptons_pt->EvalInstance(el_idx) << " " << m_leptons_cluster_eta->EvalInstance(el_idx) << " "  <<  m_leptons_id_tight->EvalInstance(el_idx) << " "<< m_leptons_iso_wp->EvalInstance(el_idx) <<std::endl;
//    }
//    return result;
//}
//
//bool EventSelection_lfv_leplep_default::mu_selection(int mu_idx) const {
