...
double OtherJetsSF::getValue() const {
  ...
  if    ( 
          ...
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBveto1p_1up") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 1 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBveto1p_1up") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 1 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBveto3p_1up") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 3 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBveto3p_1up") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 3 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBtag1p_1up") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 1 && f_n_bjets > 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBtag1p_1up") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 1 && f_n_bjets > 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBtag3p_1up") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 3 && f_n_bjets > 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBtag3p_1up") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 3 && f_n_bjets > 0) 
        ) {
    if (f_n_bjets == 0)
      ...
      retval = 1.0+fabs(retval-1.0);
          ...
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBveto1p_1down") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 1 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBveto1p_1down") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 1 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBveto3p_1down") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 3 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBveto3p_1down") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 3 && f_n_bjets == 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBtag1p_1down") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 1 && f_n_bjets > 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBtag1p_1down") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 1 && f_n_bjets > 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_ElBtag3p_1down") && f_lep_0 == 2 && f_tau_0_n_charged_tracks == 3 && f_n_bjets > 0) ||
          (fSysName.Contains("FakeFactor_OtherJetsReweight_MuBtag3p_1down") && f_lep_0 == 1 && f_tau_0_n_charged_tracks == 3 && f_n_bjets > 0) 
         ) {
    if (f_n_bjets ==0 )
      retval = retval-fabs(retval-1.0);
    else 
