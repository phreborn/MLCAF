...
s_nominal_dir='batchOutput/unmerged_MultiJetsLFR-FF-SYS-NOMINAL'
...
def copyJobs(sys):
    ...
    os.system('mkdir -pv batchOutput/unmerged_MultiJetsLFR-FF-SYS-{:s}'.format(sys))
    ...
    for files in l_files:
      ...
      for file in l_file:
        os.system('ln -sv ../../{:s} batchOutput/unmerged_MultiJetsLFR-FF-SYS-{:s}'.format(file,sys))
