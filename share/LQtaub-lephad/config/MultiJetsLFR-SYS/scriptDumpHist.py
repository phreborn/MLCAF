...
if __name__ == '__main__':
  ...
  variations = {
                'samples-analyzed-LQtaub-lephad-MultiJetsLFR-FF-SYS-NOMINAL.root': None,
                'samples-analyzed-LQtaub-lephad-MultiJetsLFR-FF-SYS-MultiJetsLFR.root': 'LQtaub-lephad/auxData/variations/systematics-Fake-MJ.txt',
                'samples-analyzed-LQtaub-lephad-MultiJetsLFR-FF-SYS-Top_Reweight.root': 'LQtaub-lephad/auxData/variations/systematics-Top-Reweight.txt',
                }  
