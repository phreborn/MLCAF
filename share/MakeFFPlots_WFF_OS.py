...
def MakeFFPlots():
    ...
    #file_FF_dphi1 = TFile.Open(path+"WCR"+Year+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi1.root") 
    #file_FF_dphi2 = TFile.Open(path+"WCR"+Year+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi2.root")
    ...
    file_FF_dphi1 = TFile.Open(path+"WCR17"+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi1.root") 
    file_FF_dphi2 = TFile.Open(path+"WCR17"+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi2.root")
    file_FF_dphi3 = TFile.Open(path+"WCR17"+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi3.root")
    file_FF_dphi4 = TFile.Open(path+"WCR17"+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi4.root")

    if not file_FF_dphi1 or not file_FF_dphi2 or not file_FF_dphi3 or not file_FF_dphi4:
        print "Error! Can not open the file!"
        return

    Hist_FF_dphi1 = file_FF_dphi1.Get(Tags+"FF_"+channel+"_TauPtFF"+Tags+Ntracks+"Dphi1")
    Hist_FF_dphi2 = file_FF_dphi2.Get(Tags+"FF_"+channel+"_TauPtFF"+Tags+Ntracks+"Dphi2")
    ...
    Canvas = TCanvas("Canvas","WCR"+Year+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi")
    Canvas.cd()
    ...
    leg.AddEntry(Hist_FF_dphi1,"#Delta#phi(#tau,MET)<1.0","l")
    leg.AddEntry(Hist_FF_dphi2,"1.0<#Delta#phi(#tau,MET)<2.0","l")
    ...
    tex3 = TLatex(0.6,0.64,"Tau FF, "+channel+", "+Tags+", "+Ntracks)
    tex3.SetNDC();
    tex3.SetTextFont(42)
    ...
    Canvas.Update()
    Canvas.SaveAs(path+"WCR"+Year+Tags+channel+"TauPtFF"+Tags+Ntracks+"Dphi.png")
