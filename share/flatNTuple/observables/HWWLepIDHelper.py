...
selections_2L.electron_id = {
               ...
               #"isolationGradientElec"   : ["char", "passIsoGradient", 1, "TRUE", True, 0., 1e9]
               #"isolationGradientLooseElec"   : ["char", "passIsoGradientLoose", 1, "TRUE", True, 0., 1e9]
               #"isolationLooseElec"   : ["char", "passIsoLoose", 1, "TRUE", True, 0., 1e9]
               }
...
selections_2L.muon_id = {
           ...
           #"isolationGradientMuon"   : ["char", "passIsoGradient", 1, "TRUE", True, 0., 1e9]
           #"isolationGradientLooseMuon"   : ["char", "passIsoGradientLoose", 1, "TRUE", True, 0., 1e9]
           #"isolationLooseMuon"   : ["char", "passIsoLoose", 1, "TRUE", True, 0., 1e9]
           }
