...
def addObservables(config):
    ...
    # TODO: these paths are of course not valid for CAFExample - add these files in CAFExample and use PathResolver
    ...
    for var in sfsystematics:
        ...
        if config.getTagBoolDefault("includeBtagWeightInMainWeight",False): 
