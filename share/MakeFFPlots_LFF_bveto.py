...
def MakeFFPlots():
    ...
    Hist_FF_dphi4 = file_FF_dphi4.Get(Tags+"FF_"+channel+"_LeptonPtDphi4"+FFName+"FF")
    ...
    Hist_FF_dphi4.SetTitle("Lepton Fake Factor")    
    ...
    Canvas = TCanvas("Canvas","LFR"+Year+Tags+channel+"LeptonPtDphi"+FFName+"FF")
    Canvas.cd()
    ...
    leg.AddEntry(Hist_FF_dphi4,"#Delta#phi(lep,MET)>2.0","l")
    leg.Draw()
    leg.SetFillColor(0)
    ...
    Canvas.Update()
    Canvas.SaveAs(path+"LFR"+Year+Tags+channel+"LeptonPtDphi"+FFName+"FF.png")
