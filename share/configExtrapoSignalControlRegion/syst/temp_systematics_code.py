...
def main():
  ...
  dir = 'sampleFolders/analyzed/samples-analyzed-htautau_lephad_sr_reweight-'
  ...
  path_mc = '/mc16c/{:s}/[Top+Ztautau+Diboson+Zee+Zmumu]'.format(channel)
  path_wjets_data = '/mc16c/{:s}/WJETSFakes/data/[data15*+data16*]'.format(channel)
  path_wjets_mc = '/mc16c/{:s}/WJETSFakes/mc/[Top+Ztautau+Diboson+Zee+Zmumu]'.format(channel)
  path_wjets_qcd = '/mc16c/{:s}/WJETSFakes/QCD/data/[data15*+data16*]'.format(channel)
  path_qcd_data = '/mc16c/{:s}/QCDFakes/data/[data15*+data16*]'.format(channel)
  path_qcd_mc = ''
    # different sf paths because we dont use mc in btag anti-iso (qcd bkg)
  #if not b_isbtag:
  #  path_qcd_mc = '-/mc16c/{:s}/QCDFakes/mc/[Top+Ztautau+Diboson+Zee+Zmumu]'.format(channel)
...
#  ['treevariation', 'MET_SoftTrk_ScaleDown', 'MET_SoftTrk_ScaleUp'],
  ...
  l_extraposfs=[
  ["extraposf","ExtrapolationSFs_Btag1p_1down","ExtrapolationSFs_Btag1p_1up"],
  ["extraposf","ExtrapolationSFs_Btag3p_1down","ExtrapolationSFs_Btag3p_1up"],
  ["extraposf","ExtrapolationSFs_Bveto1p_1down","ExtrapolationSFs_Bveto1p_1up"],
  ["extraposf","ExtrapolationSFs_Bveto3p_1down","ExtrapolationSFs_Bveto3p_1up"],
  ]
